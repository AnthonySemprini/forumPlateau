        ...
        <div id="mainpage">
            ...
            <header>
                ...
                <nav class="navBar  ">
                    ...
                    <div id="nav-right" class="navRight">
                    <?php
                        
                        if(App\Session::getUser()){
                            ?>
                            <a href="index.php?ctrl=forum&action=profilUser&id=<?= App\Session::getUser()->getId() ?>">
                            <span class="fas fa-user"></span><?= App\Session::getUser() ?></a>
                            <span>&nbsp;-&nbsp;</span>
